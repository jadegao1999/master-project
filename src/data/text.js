...
const textList = [
  ...
  new Dialog('9', '"come over here and help your sister!" ', null, 'left'),
  ...
  new Dialog('12', '"Mom forced our sister-in-law to hand over the fine silk she just got as a birthday gift to make me this cheongsam..." ', null, 'left'),
  new Narrative('13', 'Seeing you with a puzzled face, Baoluo explains,'),
  new Dialog('14', '"and she pawned her very own old furs to buy me these bracelets and rings..." ', null, 'left'),
  ...
  new Dialog('18', '"Oh, you are wearing them! See, I thought it\'s a good match for the color of Baoluo\'s cheongsum."', null, 'left'),
  ...
  new Dialog('22', '"Thanks Liusu! I told mom that this is your favorite pair, but she ..."', null, 'left'),
  ...
  new Dialog('26', '"Mothers in Shanghai are pushing their daughters to the party. You have to stand out.  It\'s hard to find a perfect marriage candidate like Liuyuan."', null, 'left'),
  new Dialog('27', '"I heard that his family owns a successful business in London, and he is the ONLY SON!!"', null, 'left'),
  ...
  new Dialog('30', '"He is also young and unattached! If Baoluo can climb this high branch, our Bai family may be able to bring back the past glories.."', null, 'left'),
  ...
  new Dialog('39', '"That must be Liuyuan!"', null, 'left'),
  ...
  new Dialog('51', '“I remember when I was a little boy, about 25 years ago, there was no ballroom at all."', null, 'left'),
  new Dialog('52', '“Of course, there was also no woman as charming as either of you."', null, 'left'),
  ...
  new Dialog('57', '"I stayed in Shanghai until I was eight, and then I followed my mother to London to reunite with my father"', null, 'left'),
  new Narrative('58', 'The speaker inside Paramount rings loudly in a sudden:', null, ['liuyuan', 'liusu_green']),
  new Dialog('59', '"Ladies and gentlemen, are you ready? Our first dance is about to begin!"', null, 'left'),
  //button here: ...?!
